...
async function readIgnoreFiles(): Promise<string[]> {
  ...
  // [[GitignoreConfig89012|Get gitignore setting from VS Code configuration]]
  ...
  for (const folder of workspaceFolders) {
    // [[GitignoreRead34567|Read .gitignore first (if enabled) - lower priority]]
    if (useGitignore) {
    ...
    // [[CommentIgnorePriority78901|Read .commentlinkingignore last - higher priority, can override .gitignore]]
